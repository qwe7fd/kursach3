...
namespace kursach
{
    public partial class SearchHerbByName : Form
    {
        private List<Herb> allHerbs;

        public SearchHerbByName()
        {
            InitializeComponent();
        ...
        {
            string searchName = txtSearchHerb.Text.Trim();

            List<Herb> currentFoundHerbs = Herb.SearchByName(allHerbs, searchName);
